...
use App\Modules\Catalog\Filament\Vendor\Resources\VendorRentalServiceResource\Pages;
...
class VendorRentalServiceResource extends Resource
{
        ...
        return $table
            ...
            ->actions([
                Action::make('submitForReview')
                    ...
                    ->visible(fn (Service $record): bool => in_array($record->status, [ServiceStatus::Draft, ServiceStatus::ChangesRequested], true))
    ...
    {
        return [
            'index' => Pages\ListVendorRentalServices::route('/'),
            'create' => Pages\CreateVendorRentalService::route('/create'),
            'edit' => Pages\EditVendorRentalService::route('/{record}/edit'),
        ];
    }
