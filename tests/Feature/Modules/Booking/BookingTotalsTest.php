...
it('booking GET returns per-vendor breakdown', function (): void {
    ...
    $vendor1 = \App\Modules\Identity\Domain\Models\VendorProfile::factory()->create();
    $vendor2 = \App\Modules\Identity\Domain\Models\VendorProfile::factory()->create();

    $service1 = \App\Modules\Catalog\Domain\Models\Service::factory()->create([
        'product_type'      => ProductType::Digital,
        'status'            => ServiceStatus::Published,
